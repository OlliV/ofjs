...
module.exports.getrawtype = decode.rawtype;
...
decode.ethernet = function (rawPacket, offset, { decodeEthernetPayload } = { decodeEthernetPayload: true }) {
  let ret = {
...
module.exports.decodeethernet = decode.ethernet;
